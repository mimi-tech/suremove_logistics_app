...
class AllYearlyEarnings extends StatefulWidget {
  const AllYearlyEarnings({Key? key}) : super(key: key);

  @override
  State<AllYearlyEarnings> createState() => _AllYearlyEarningsState();
}

class _AllYearlyEarningsState extends State<AllYearlyEarnings> {
  ...
  void initState() {
    ...
    earningsList  =  AdminBloc.getYearlyEarnings(user,driver.driverId);
  }
